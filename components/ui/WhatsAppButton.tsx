  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-50 group flex items-center gap-2
        ...
        h-[52px] w-[52px] hover:w-auto overflow-hidden
        pl-0 hover:pl-[14px] pr-0 hover:pr-[16px]
        justify-center hover:justify-start"
      style={{ transition: 'width 0.3s cubic-bezier(0.16,1,0.3,1), padding 0.3s cubic-bezier(0.16,1,0.3,1), box-shadow 0.3s ease, transform 0.3s ease' }}
    >
      {/* WhatsApp SVG icon */}
      <svg
      ...
      {/* Label — expands on hover via CSS group */}
      <span
        className="text-[13.5px] font-semibold whitespace-nowrap
          max-w-0 group-hover:max-w-[120px] overflow-hidden
