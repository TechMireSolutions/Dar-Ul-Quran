...
export default function WhatsAppButton({ number }: WhatsAppButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span
        className="text-[13.5px] font-semibold whitespace-nowrap max-w-0 group-hover:max-w-[120px] overflow-hidden opacity-0 group-hover:opacity-100 transition-all duration-300"
        aria-hidden="true"
      >
        واٹس ایپ
      </span>
